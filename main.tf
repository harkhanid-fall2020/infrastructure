...
# resource "aws_codedeploy_deployment_config" "lambda_deploy_config" {
...
#   deployment_config_name = aws_codedeploy_deployment_config.lambda_deploy_config.id
#   deployment_style {
#     deployment_option = "WITH_TRAFFIC_CONTROL"
#     deployment_type   = "BLUE_GREEN"
#   }

#   service_role_arn = aws_iam_role.CodeDeployLamdaServiceRole.arn
# }


# resource "aws_iam_role" "CodeDeployLamdaServiceRole" {
...
# resource "aws_iam_role_policy_attachment" "codeploy_lambda_role_attachment" {
#   role = aws_iam_role.CodeDeployLamdaServiceRole.id
#   policy_arn = "arn:aws:iam::aws:policy/service-role/AWSCodeDeployRole"
# }
